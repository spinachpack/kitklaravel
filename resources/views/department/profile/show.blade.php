...
<div class="row">
    ...
    <div class="col-lg-4 col-md-12 mb-4">
        <div class="card">
            <div class="card-body text-center p-4">
                <img src="{{ asset('uploads/profiles/' . (auth()->user()->profile_picture ?: 'default-avatar.png')) }}" class="rounded-circle mb-3" style="width: 150px; height: 150px; border: 5px solid var(--primary-blue); object-fit: cover;" alt="Profile">
                <h5>{{ $user->first_name }} {{ $user->last_name }}</h5>
                <p class="text-muted mb-3">{{ $user->id_number }}</p>
                
                <form method="POST" action="{{ route('department.profile.picture') }}" enctype="multipart/form-data" id="pictureForm">
                    @csrf
    ...
    <div class="col-lg-8 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('department.profile.update') }}">
                    @csrf
                    <div class="row">
                    ...
                    <a href="{{ route('department.profile.change-password') }}" class="btn btn-warning">
