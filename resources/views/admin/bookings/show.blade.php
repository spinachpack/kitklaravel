                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        @if($booking->equipment->image)
                            <img src="{{ $booking->equipment->image_url }}" class="img-fluid rounded" style="max-width: 300px;" alt="Equipment">
                        @endif
                    </div>
                </div>
        ...
        @if($booking->status === 'pending')
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.bookings.reject', $booking->id) }}" class="mt-2">
                        @csrf
                        <div class="mb-3">
