                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            @if($booking->status === 'pending')
                                                <hr>
                                                <form method="POST" action="{{ route('admin.bookings.approve', $booking->id) }}" id="approveForm{{ $booking->id }}">
                                                    @csrf
                                                    <div class="mb-3">
                                                ...
                                                <form method="POST" action="{{ route('admin.bookings.reject', $booking->id) }}" class="mt-2" id="rejectForm{{ $booking->id }}">
                                                    @csrf
